...
st.markdown("""
    <style>
        ...
        .main-title { text-align:center; font-size:2.4em; color:#184187; font-weight:700; margin-bottom:0; }
        .subtitle { text-align:center; font-size:1.1em; color:#555; margin-bottom:1.2em; }
        .cockpit-table { width:100%; border-collapse:collapse; border-radius:8px; overflow:hidden; }
        .cockpit-table th { background:#184187; color:#fff; font-weight:600; }
        .cockpit-table th, .cockpit-table td { border:1px solid #e3e9f0; padding:10px 0; text-align:center; }
        .cockpit-table tr:nth-child(even) { background: #f5f7fa; }
        .cockpit-table td:first-child { text-align:left; padding-left:12px; }
        .alert { color:#d23232; font-size:1.1em; font-weight:500; margin-top:8px; }
        .info { color:#184187; font-weight:500; }
    </style>
...
st.markdown(f"<div class='subtitle'>A clean, modern mass & balance calculation tool for small aircraft</div>", unsafe_allow_html=True)
